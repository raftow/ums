...
class UmsModuleAfwStructure
{
	...
	public static $DB_STRUCTURE = array(
		...
		'smd' => array(
			...
			'POLE' => false,
			'FGROUP' => 'smd',
			'HELP' => 'يتم التقسيم إلى وحدات فرعية باعتبار أهداف النظام ومراعاة للنواحي العملية ومنها تجميع مع بعض الجداول التي يمكن لوظيفة من وظائف مستخدمي  النظام الاطلاع على بياناتها ',
			'SHOW' => true,
			'ROLES' => '',
			'FORMAT' => 'retrieve',
			'EDIT' => false,
		...
		'allRoles' => array(
			...
			'SHOW' => true,
			'FORMAT' => 'retrieve',  // was before tree but tree use IFrames not secure
		...
		'otherGoalList' => array(
			...
			'QEDIT' => false,
			'READONLY' => true,
			'PHP_FORMULA' => 'list_extract.goalConcernList.goal_id.',
			'STEP' => 11,
			'SEARCH-BY-ONE' => '',
			'DISPLAY' => false,
			'DISPLAY-UGROUPS' => '',
