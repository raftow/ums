<?php 
        class UmsJobAroleAfwStructure
        {
			...
			'jobrole_id' => array('IMPORTANT' => 'IN',  'SEARCH' => true,  'SHOW' => true,  'RETRIEVE' => true,  'EDIT' => true,  'QEDIT' => true,  'SIZE' => 40,  'SEARCH-ADMIN' => true,  'SHOW-ADMIN' => true,  'EDIT-ADMIN' => true,  'UTF8' => false,  
				'TYPE' => 'FK',  'ANSWER' => 'jobrole',  'ANSMODULE' => 'ums',  'MANDATORY' => true,  
			...
			'module_id' => array('IMPORTANT' => 'IN',  'SEARCH' => false,  'SHOW' => true,  'RETRIEVE' => true,  'EDIT' => true,  'QEDIT' => true,  'SIZE' => 40,  'UTF8' => false,  
				...
				'RELATION' => 'OneToMany',  
				'WHERE' => "id_module_type=5 and id_pm in (select id_domain from §DBPREFIX§ums.jobrole where id = §jobrole_id§)", 
                                'DEPENDENCIES' => ['jobrole_id'],
                                'DEPENDENT_OFME' => array("arole_id"), 
			...
			'arole_id' => array('IMPORTANT' => 'IN',  'SEARCH' => false,  'SHOW' => true,  'RETRIEVE' => true,  'EDIT' => true,  'QEDIT' => true,  'SIZE' => 40,  'UTF8' => false,  
				'TYPE' => 'FK',  'ANSWER' => 'arole',  'ANSMODULE' => 'ums',  'MANDATORY' => true,  'DEFAUT' => 0,  
				'RELATION' => 'OneToMany',  
