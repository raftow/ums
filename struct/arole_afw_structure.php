...
class UmsAroleAfwStructure
{
	...
	public static $DB_STRUCTURE = array(
		...
		'system_id' => array(
			...
			'CATEGORY' => 'FORMULA',
			'FIELD-FORMULA' => 'fnGetModuleSystemId(module_id)',
			'FORMULA_MODULE' => 'ums',
			'DISPLAY' => true,
			'STEP' => 1,
			'DISPLAY-UGROUPS' => '',
		...
		'titre' => array(
			...
			'SEARCH' => true,
			'SHOW' => true,
			// too much fields 'RETRIEVE-AR' => true,
			'EDIT' => true,
			'QEDIT' => false,
			'UTF8' => true,
			'SIZE' => 255,
		...
		'titre_en' => array(
			...
			'SEARCH' => true,
			'SHOW' => true,
			// too much fields 'RETRIEVE-EN' => true,
			'EDIT' => true,
			'QEDIT' => false,
			'UTF8' => false,
			'SIZE' => 255,
		...
		'rbfListCount' => array(
			...
			'TYPE' => 'INT',
			'CATEGORY' => 'FORMULA',
			'PHP_FORMULA' => 'countFKItems.rbfList',
			'STEP' => 4,
			'SEARCH-BY-ONE' => '',
			'DISPLAY' => true,
			'DISPLAY-UGROUPS' => '',
		...
		'all_rbfListCount' => array(
			...
			'TYPE' => 'INT',
			'CATEGORY' => 'FORMULA',
			'PHP_FORMULA' => 'countFKItems.all_rbfList',
			'STEP' => 4,
			'SEARCH-BY-ONE' => '',
			'DISPLAY' => true,
			'DISPLAY-UGROUPS' => '',
