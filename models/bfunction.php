...
class Bfunction extends UmsObject
{
        ...
        public static function loadNonTabledBfunction(
                $id_system,
                $file_specification,
                $bf_specification = "",
                $direct_access = "N",
                        ...
                        if ($id_oper_bf) {
                                ...
                                foreach ($goalConcernList as $goalConcernObj) {
                                        ...
                                        if ($jroleObj) {
                                                ...
                                                $errors[]  = "السعي : [$goalConcernObj_display] لا يحتوي على صلاحية تنفذه";
                                        }
                                }
                        } else {
...
";                        
        ...
        public static function getBfunction($id_system, $file_specification, $curr_class_module_id, $curr_class_atable_id, $bf_specification = "")
        {
                ...
                if ($curr_class_atable_id == 13952 and $file_specification == "qedit") die("sql for curr_class_atable_id=$curr_class_atable_id => " . $bf->getSQL());
                if ($bf->load()) {
