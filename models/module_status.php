...
class ModuleStatus extends AFWObject{
	...
	public static $DATABASE		= ""; public static $MODULE		    = "ums"; public static $TABLE			= ""; public static $DB_STRUCTURE = null; /* = array(
		...
		"titre_short" => array("SEARCH" => false, "SHOW" => true, "RETRIEVE" => true, "EDIT" => true, "QEDIT" => true, "SIZE" => 40, "MANDATORY" => true, "UTF8" => true, "SHORTNAME" => "title", "TYPE" => "TEXT"),
		"titre_short_en" => array("SEARCH" => true, "SHOW" => true, "RETRIEVE" => true, "EDIT" => true, "QEDIT" => true, "SIZE" => 40, "SEARCH-ADMIN" => true, "SHOW-ADMIN" => true, "EDIT-ADMIN" => true, "MANDATORY" => true, "UTF8" => false, "TYPE" => "TEXT"),
		"titre" => array("SEARCH" => false, "SHOW" => true, "RETRIEVE" => true, "EDIT" => true, "QEDIT" => false, "SIZE" => 96, "MANDATORY" => true, "UTF8" => true, "TYPE" => "TEXT"),
		"titre_en" => array("SEARCH" => true, "SHOW" => true, "RETRIEVE" => true, "EDIT" => true, "QEDIT" => false, "SIZE" => 96, "SEARCH-ADMIN" => true, "SHOW-ADMIN" => true, "EDIT-ADMIN" => true, "MANDATORY" => true, "UTF8" => false, "TYPE" => "TEXT"),
